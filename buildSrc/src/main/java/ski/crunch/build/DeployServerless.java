...
public class DeployServerless extends Exec {
    ...
    @Inject()
    public DeployServerless() {
        super.setDescription("Calls the Serverless executable to deploy a module. To set the stage pass a system" +
