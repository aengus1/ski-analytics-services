...
AWSCredentials awsCreds = new ProfileCredentialsProvider(profileName).getCredentials();
        return  AWSCognitoIdentityProviderClientBuilder
                .standard()
                .withCredentials(new AWSStaticCredentialsProvider(awsCreds))
                .withRegion(Regions.fromName(this.region))
     ...
     Optional<String> performAdminSignup(String username, String password) {
     ...
     void deleteUser(String userName) {
        ...
        try {
            AWSCognitoIdentityProvider cognitoIdentityProvider = buildIdpWithCreds(profileName);
            AdminDeleteUserResult deleteUserResult = cognitoIdentityProvider.adminDeleteUser(deleteUserRequest);
            String result = deleteUserResult.toString();
    ...
    private RespondToAuthChallengeRequest userSrpAuthRequest(InitiateAuthResult challenge,
        ...
        try {
            ...
            byte[] secretBlock = decode(challenge.getChallengeParameters().get("SECRET_BLOCK"));
        ...
        srpAuthResponses.put("PASSWORD_CLAIM_SIGNATURE", new String(encode(hmac), StringUtils.UTF8));
    ...
    private String calculateSecretHash(String userPoolClientId, String userPoolClientSecret, String userName) {
        ...
        try {
            ...
            return getEncoder().encodeToString(rawHmac);
        } catch (Exception e) {
