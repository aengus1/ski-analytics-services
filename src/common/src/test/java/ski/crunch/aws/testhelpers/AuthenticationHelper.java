...
public class AuthenticationHelper {
    ...
    public AuthenticationHelper(String userPoolID, String userPoolClientId, String secretKey, String region, String profileName) {
        do {
...
//        }
    ...
    AWSCognitoIdentityProvider buildIdpWithCreds(String profileName) throws Exception {
