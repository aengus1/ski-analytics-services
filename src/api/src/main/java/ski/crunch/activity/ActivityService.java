...
public class ActivityService {
     ...
     */
    private void writeRawFileToS3(String bodyStr, String activityId) throws SaveException {
        try {
            byte[] body = null;
            body = Base64.decode(bodyStr);
            LOG.debug("decoded raw activity base64 to binary");
            ByteArrayInputStream bais = new ByteArrayInputStream(body);
            s3.putObject(bais, s3RawActivityBucket, activityId, body.length, "rawActivity");
        } catch (IOException e) {
    ...
    /**
     * method deletes raw activity from s3
     * @param id
     * @return
     */
    ...
    /**
     * Method deletes activity record from table
     * @param id
     * @return
     */
